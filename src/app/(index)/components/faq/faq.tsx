...
const faqData: FaqItemPropsType[] = [
  ...
  },
  {
    ...
    answer: (
      <>
        主に契約書、証明書、権利書など、重要な文書がNFT化可能です。また、著作権を持つデジタル作品や資格証明書なども対象になります。
      </>
    ),
  },
  {
  ...
  },
  {
    ...
    answer: <>もちろん可能です。ご気軽にサポートLINEにご連絡ください。</>,
  },
  {
    id: '6',
    ...
    answer: (
      <>
        アプリ「DIVER
        Biz」の初期設定時に生成される復元フレーズ（12個の単語）を大切に保管、管理してください。復元フレーズ（12個の単語）は、デバイスの変更やアプリを削除した場合などのアプリ再インストール時に、同じデジタルドキュメントにアクセスするために必須となります。
      </>
    ),
  },
  {
    id: '7',
    question:
      '発行したデジタルドキュメントを受信者が紛失することはありますか？また再発行は可能ですか？',
    answer: (
      <>
        一度受信したら紛失することはありません。アプリ「DIVER
        Biz」をインストール済みのデバイスを紛失した場合は、復元フレーズ（12個の単語）を利用して新規デバイスでアプリの情報を復元できるので安心です。
        <br />
        <br />
...
const FAQ = () => {
  ...
  return (
    <div
      ref={ref}
      id="faq"
      className="mb-[30px] px-4 pb-12 pt-14 md:mb-[140px] md:pb-[55px] md:pt-[76px]"
    >
      <div className="mx-auto w-full max-w-[920px]">
        <h4 className="font-roboto text-center text-[28px] font-bold text-[#0D0A8E] md:text-[48px]">
          FAQ
        </h4>
